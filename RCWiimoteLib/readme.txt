...
This project is a managed library for the Nintendo Wii Remote (Wiimote).

It has been developed from a library provided by Brian Peek, the details 
of which are shown below.

This version adds camera calibration functions and datastructures from
EmguCV, an open source .NET wrapper for OpenCV, the open source Computer 
Vision Library originally developed by Intel. Some threading issues 
present in the original library are also solved.
